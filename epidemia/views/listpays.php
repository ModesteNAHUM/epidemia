...
$result = mysqli_query($conn, "SELECT * FROM ajout_pays ORDER BY id DESC"); // using mysqli_query instead
...
<a href="../views/ajout_pays.php" class="lien">Ajouter un nouveau pays</a><br/><br/>
    ...
    while ($res = mysqli_fetch_array($result)) {
        ...
        <td style="text-align: center; text-decoration:none;"><a href="../model/delete.php?id=<?php echo $res['id'];?>"><button type="button" class="btn btn-outline-light" name="supr"><i class="fa fa-trash" aria-hidden="true"></i></button></a></td>
